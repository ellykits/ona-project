...
public class AuthorizeAccess extends SessionUseCase<String> {
    private final SessionRepository mSessionRepository;

    public AuthorizeAccess(@NotNull TransformerForSingle<String> transformer, SessionRepository
            sessionRepository) {
        super(transformer);
    ...
    protected Single<String> createObservable(@Nullable Optional<Map<String, String>> optionalData) {
        return mSessionRepository.isUserLoggedIn();
    }
}
